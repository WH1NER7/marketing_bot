...
inline_btn_2 = InlineKeyboardButton(text="Помогите мне! У меня проблема", url="https://t.me/LacriceBrand_manager_bot")
...
advert_button1 = InlineKeyboardButton(text="Cмотреть каталог", url="https://missyourkiss.mobz.click/wvahf1")
# problems_kb_btn2 = InlineKeyboardButton(text="Получить гайд", url="https://b24-dvx7b9.bitrix24.site/crm_form_ru7u6/")

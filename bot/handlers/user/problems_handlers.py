...
\n\
Если у Вас остались вопросы - задайте их менеджеру, нажав на соответствующую кнопку в всплывающем меню, или получите захватывающий и полезный “Гайд по стилю” указав свой номер телефона в чате с менеджером.\n\
\n\
...
\n\
Примите наши извинения. Задайте оставшиеся вопросы менеджеру, нажав на соответствующую кнопку в всплывающем меню, или получите захватывающий и полезный “Гайд по стилю” указав свой номер телефона в чате с менеджером. \n\
\n\
С любовью, MissYourKiss!) \n\
", reply_markup=problems_kb_add)
...
\n\
Также, в качестве извинения, получите захватывающий и полезный “Гайд по стилю” указав свой номер телефона в чате с менеджером.\n\
\n\
...
Подобные ситуации бывают крайне редко, так как каждое изделие проходит тщательную проверку. Для исключения подобных ситуаций в дальнейшем, мы расширяем штат сотрудников. Надеемся, что эта ситуация не испортила Ваше впечатление о нашем бренде.\n\
    \n\
Примите наши извинения. По дополнительным вопросам, Вы всегда можете обратиться к нам,нажав на соответствующую кнопку в всплывающем меню, или получить захватывающий и полезный “Гайд по стилю” указав свой номер телефона в чате с менеджером.\n\
\n\
...
\n\
По дополнительным вопросам, Вы всегда можете обратиться к нам,нажав на соответствующую кнопку в всплывающем меню, или получить захватывающий и полезный “Гайд по стилю” указав свой номер телефона в чате с менеджером.\n\
\n\
...
\n\
В качестве приятного бонуса примите от наc полезный “Гайд постилю”, для этого укажите свой номер телефона перейдя в чат с менеджером.\n\
\n\
С любовью, MissYourKiss!)\n\
", reply_markup=problems_kb_add)
...
\n\
Также у Вас есть возможность получить захватывающий и полезный “Гайд по стилю” указав свой номер телефона в чате с менеджером.\n\
\n\
С уважением, MissYourKiss! \n\
", reply_markup=problems_kb_add)
...
\n\
По дополнительным вопросам Вы всегда можете обратиться к нам нажав на кнопку “ Свяжите меня с менеджером” и мы в ближайшем времени ответим Вам! Также получите приятный бонус “ Гайд по стилю“. Для этого перейдите по кнопке.\n\
\n\
С уважением, команда MissYourKiss!\n\
", reply_markup=problems_kb_add)
...
\n\
Приносим свои глубочайшие извинения. Примите от нас приятный бонус ”Гайд по стилю”. Для этого перейдите в чат с менеджером.\n\
\n\
С уважением, MissYourKiss!\n\
", reply_markup=problems_kb_add)

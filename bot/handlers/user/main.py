...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/IMG_4323.MOV'
    ...
    message_template = (
        "<b>Какой цвет белья привлечёт деньги?</b> 💸\n\
\n\
Говорят, что есть оттенки, которые прямо заряжены на богатство.\n\
Хочешь проверить на себе? 👀\n\
\n\
Мы собрали список цветов, которые не только украсят твоё тело, но и помогут притянуть удачу (и финансы!) 👇🏻"
    )

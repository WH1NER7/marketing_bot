...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_24.png'

    blocked_users = 0
    successful_sends = 0

#
    text_with_link = "А как часто вы обновляете гардероб с нижним бельём?\n\
Сегодня хотим дать пару рекомендаций и советов🥰\n\
\n\
Бюстгальтеры: Меняйте каждые 6-9 месяцев или чаще, если носите ежедневно.\n\
Трусики: Меняйте каждые 3-6 месяцев. \n\
\n\
Стирайте бюстгальтеры и трусики на деликатном режиме в стиральной машине или вручную без замачивания.\n\
\n\
Сушите на воздухе, а не в сушильной машине. \n\
\n\
Храните бюстгальтеры и трусики в ящиках или органайзерах для сохранения формы.\n\
\n\
Не складывайте белье слишком плотно, иначе оно может деформироваться.\n\
 \n\
А также:\n\
\n\
Регулярно проверяйте белье на признаки износа, такие как растянутые резинки или выцветшие ткани. Избавляйтесь от белья, которое больше не подходит или неудобно.\n\
\n\
Придерживаясь данной рекомендации, бельё прослужит Вам дольше❤️"

...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_27.png'

    blocked_users = 0
    successful_sends = 0

#
    text_with_link = "Вот несколько способов, как можно заботиться о себе:\n\
\n\
Утренний ритуал: Создайте ежедневную рутину, которая подготовит вас к предстоящему дню, например, вставайте раньше, выражайте благодарность, занимайтесь спортом и наслаждайтесь питательным завтраком.\n\
\n\
Медитация: Уделите время для успокоения своего ума и сосредоточения на настоящем моменте. Можно медитировать 5-10 минут в день.\n\
\n\
Время на природе: Прогуляйтесь на свежем воздухе в течение 20-30 минут, чтобы поднять настроение и освежиться.\n\
\n\
Хобби: Выберите занятие, которое приносит вам удовольствие и удовлетворение, например, рисование, чтение, музыка или другое хобби по вашему выбору.\n\
\n\
Вечерний ритуал: Создайте расслабляющую вечернюю рутину, которая поможет вам переключиться перед сном. Зажгите свечи, почитайте книгу, запишите свои мысли в дневник, примите ванну наденьте красивое нижнее белье.\n\
\n\
Самозабота помогает нам быть здоровыми и счастливыми. Выберите то, что вам нравится, и делайте это каждый день."

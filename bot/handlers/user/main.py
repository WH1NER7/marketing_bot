...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_25.png'

    blocked_users = 0
    successful_sends = 0

#
    text_with_link = "Как нижнее белье отражается на ментальном состоянии?\n\
\n\
🔸 1. Уверенность в себе\n\
\n\
Правильно подобранное нижнее белье повышает самооценку и уверенность, делая нас более открытыми и общительными.\n\
\n\
🔸 2. Комфорт и расслабление\n\
\n\
Неудобное белье может вызывать раздражение и отвлекать, удобное же позволяет сосредоточиться на важных делах.\n\
\n\
🔸 3. Личное выражение\n\
\n\
Нижнее белье — это способ самовыражения: яркие цвета поднимают настроение, нейтральные создают ощущение спокойствия.\n\
\n\
🔸 4. Связь с телом\n\
\n\
Красивое белье помогает принимать тело и любить себя, акцентируя внимание на деталях.\n\
\n\
🔸 5. Эмоциональное состояние\n\
\n\
Нижнее белье может вызывать воспоминания и эмоции, поднимая настроение."

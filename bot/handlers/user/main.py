...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_43.png'
    ...
    message_template = (
        "{name} давно хотела тебе сказать\n\
\n\
Я влюбилась, в этот комплект...\n\
\n\
Лиф который классно показывает акценты, еще моя любимая сеточка.\n\
Бретели регулируются и делают образ круче. Носи как хочешь!\n\
Мягкое и удобное — забываешь, что оно на тебе.\n\
\n\
В нем я чувствую себя особенной💋"
    )

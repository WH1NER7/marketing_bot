...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/IMG_1333.MP4'
    ...
    message_template = (
        "Каждый комплект, который ты заказываешь, — это результат кропотливого труда и вдохновения наших мастеров.\n\
    \n\
С любовью и вниманием к деталям они создают твой уникальный комплект, который становится почти что индивидуальным произведением искусства.\n\
Мы хотим напомнить тебе, что в каждом стежке, каждом элементе — частичка нашей души. \n\
    \n\
Это не просто вещь, это ручная работа, в которую вложены тепло и забота наших мастеров ❤️"
    )

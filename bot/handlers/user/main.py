...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_52.png'
    ...
    message_template = (
        "{name}, тебе тут главная валентинка пришла\n\
Дорогая, ты — невероятна! \n\
\n\
Каждый день ты справляешься с миллионом задач, и это восхищает. Ты сильная, умная и прекрасная, даже если сама иногда в этом сомневаешься. Помни, что ты —чья-то гордость и вдохновение. Спасибо за то, что ты есть. 💕\n\
\n\
С любовью, твой miss your kiss"
    )

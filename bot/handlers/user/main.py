...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_63.png'
    ...
    message_template = (
        "Привет, <b>{name}!</b> \n\
Мы подготовили для тебя <b><i>предсказание на завтрашний день</i></b> 🥠\n\
    \n\
Хочешь узнать, что именно приготовили звезды? Перейди в наш Telegram-канал и выбирай фото, как чувствует твое сердце ❤️"
    )

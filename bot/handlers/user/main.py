...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_76.png'
    ...
    message_template = (
        "<b>Он здесь. Ты готова?</b>\n\
Комплект, о котором ты мечтала, уже доступен к заказу 😳\n\
    \n\
🖤🤍 <b>Белый или чёрный</b> — выбирай свое белье с акцентным вырезом и акцентным сердцем\n\
    \n\
<b>Добавь шортики</b> (не входят в комплект) — и собери образ для дома"
    )

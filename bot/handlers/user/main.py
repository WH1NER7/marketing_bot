...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_32.png'
    ...
    message_template = (
        "{name}, тебе подарок от MISS YOUR KISS в честь пятницы 13-го\n\
\n\
Дарим тебе особую скидку на изысканное нижнее белье. Это твой шанс обновить гардероб и добавить чуть больше магии и притягательности в свой образ\n\
\n\
🔥Только до 15 декабря (22:00) по промокоду MSSRK20F1A76 закажи соблазнительное белье, которое подчеркнет твою индивидуальность\n\
\n\
Спеши: удача любит тех, кто действует быстро!"
)

...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_53.png'
    ...
    message_template = (
        "Привет, наши красотки! Как дела?\n\
\n\
Вы уже знаете, что мы работаем над новой коллекцией белья? Хотим немного вас заинтриговать! 🤩 В одном из комплектов будут кружевные шортики! 🔥 А пока, полюбуйтесь на эту невероятно красивую сеточку!\n\
\n\
Скоро, совсем скоро…  🤫"
    )

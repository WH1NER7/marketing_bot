...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/IMG_6358.MOV'
    ...
    message_template = (
        "<b>Оплата у психолога не прошла, а в пункте выдачи — прошла:</b>\n\
    \n\
Иногда, чтобы почувствовать себя уверенно, не нужно искать ответы в сложных вопросах. Достаточно просто надеть белье, которое поддержит тебя в любой ситуации 💆🏻‍♀️\n\
    \n\
🙌🏻❤️‍🩹✨\n\
белье MYK — это не просто комфорт, это уверенность, которая начинается с тебя. <b><em>Ведь когда ты чувствуешь себя хорошо внутри, внешний мир кажется намного легче.</em></b>\n\
    \n\
С любовью, MYK"
    )

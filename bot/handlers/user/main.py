...
async def start(message: Message):
    ...
    await message.answer(f'Ура! Даем старт самому крутому розыгрышу на просторах интернета. Такого еще не было нигде!\n\
...
\n\
P.S. Не забудь получить от нас подарок- гайд «Reels на миллион»', reply_markup=markup_competition)
...
async def competition(message: Message):
    await message.answer('Ура! Даем старт самому крутому розыгрышу на просторах интернета. Такого еще не было нигде!\n\
Никакого рандомайзера, где фортуна может быть не на твоей стороне. На этот раз все в твоих красивых руках.\n\
Приз - новенький айфончик.\n\
Сейчас расскажу тебе об условиях конкурса.\n\
\n\

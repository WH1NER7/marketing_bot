...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    message_template = (
        "<b>Когда вокруг — суматоха, просто сделай паузу ⏸️</b>\n\
\n\
Спроси себя: <b>а мне комфортно?</b>\n\
Иногда всё, что нужно — это бельё, которое не давит, не жмёт и не напоминает о себе.\n\
\n\
💋<b>Miss Your Kiss</b> — комфорт, который чувствуешь каждый день."
    )

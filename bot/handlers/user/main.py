...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    message_template = (
        "<b>Летний must-have, в который влюбишься с первого взгляда</b> 😍\n\
    \n\
Поддерживает, не просвечивает и идеально под летние платья. Есть в нескольких принтах, а цветочный — появится совсем скоро!\n\
    \n\
О наличии сообщим в Telegram-канале, следите 🫶🏻"
    )

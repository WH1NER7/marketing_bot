...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    text_with_link = "Тренд 90-х, который в моде в 2024 🪩\n\
Кружевные брюки – отличный выбор для теплых летних вечеров. \n\
Они отлично сочетаются с пиджаком и каблуками, а так же с футболкой oversize и кроссовками 🤩\n\
\n\
🔗 [КРУЖЕВНЫЕ БРЮКИ](https://www.wildberries.ru/catalog/226608462/detail.aspx?targetUrl=MS) 🤍"

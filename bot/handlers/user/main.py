...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_49.png'
    ...
    message_template = (
        "Этот текст писала работающая девушка…\n\
\n\
Я знаю, как ты устаешь за неделю, когда наступает вечер пятницы, как будто весь груз недели падает на тебя бетонной плитой, хочется лечь и погрузится в свой уютный мир.\n\
\n\
Лично мне помогает эта медитация:\n\
\n\
 <a href='https://youtu.be/Oa6KtWWO2lY?si=xuGBsybFu1UClUB_'>Расслабляющая</a>\n\
 <a href='https://youtu.be/FZqtF0Nm4YE?si=KUjPAzlH688_TFKO'>Успокаивающая</a>\n\
\n\
Попробуй принять сегодня ванну с ними, думаю у тебя точно поднимется настроение ❤️\n\
\n\
С заботой, копирайтер MYK."
    )

...
📌 За два года на Wildberries одели в пижаму 65 тысяч девушек.\n\
\n\
...
"Оставляя положительный отзыв на Wildberries, Вы получаете возможность участвовать в розыгрышах наших товаров и других ценных призов🎉 \n\
\n\
Поставьте уведомления на боте, чтобы не пропускать акции каждую неделю 😉")
...
async def ready_present(message: types.Message):
    ...
    text_with_link = "ТРЕНД 2024 года 🌸 \n\
Мы создали невероятно комфортные ажурные пижамы для дома, которые не останутся незамеченными среди твоих близких! 😉 \n\n\
...
\n\
В нежно голубом цвете:\n\
Артикул: [205988401](https://www.wildberries.ru/catalog/217327600/detail.aspx?targetUrl=MS)\n\
"
...
def register_users_handlers(dp: Dispatcher) -> None:
    ...
    dp.register_message_handler(lottery, content_types=['text'], text="РОЗЫГРЫШИ")

...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_30.png'
    ...
    message_template = (
        "{name}, мы услышали твои пожелания и создали нечто особенное!😍\n\
    \n\
Наша новая конструкция белья идеально садится на любую фигуру!\n\
    \n\
▫️ <b>Невесомая сетка</b> подарит тебе ощущение невероятной нежности и комфорта\n\
▫️ Бюстгальтер <b>идеально сядет на твою грудь</b>, подчеркивая зону декольте и создавая соблазнительный силуэт\n\
▫️ <b>Трусики с мягкой</b> вставкой подарят тебе непревзойденный комфорт на весь день, не сковывая движений\n\
    \n\
Примерь этот комплект и почувствуй женственность ♥️"
)

...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_72.png'
    ...
    message_template = (
        "{name}, ты знала, что <b>красные трусики на люстре</b> — это не шутка, а реально рабочий ритуал на любовь?\n\
\n\
А ещё есть особые <b>цвета, украшения и даже бельё</b>, которые помогают притянуть в жизнь любовь и внимание.\n\
\n\
<i>Собрали самые классные лайфхаки, фэн-шуй приёмчики и немного магии в нашем новом посте в Telegram-канале!</i> 🫶🏻👀"
    )

...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_69.png'
    ...
    message_template = (
        "<b>{name}, какой комплект принесёт тебе удачу в этом месяце?</b>\n\
\n\
🌸🥰 Мы подготовили для тебя <b>«счастливый» комплект на эту весну на основе астрологических прогнозов</b> и актуальных fashion-трендов!\n\
\n\
Переходите в наш канал, чтобы получить индивидуальный весенний подбор! 💬"
    )

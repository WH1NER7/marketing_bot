...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_28.png'
    ...
    message_template = (
        "{name}, сегодня вечером у тебя точно было такое чувство…\n\n"
        "<b>Сняла бюстгальтер, и так легко стало на душе!</b> Знакомо? 😄\n\n"
        "<b>Есть выход</b>, попробуй наши комфортные лифы из сеточки.\n"
        "Они очень удобные, не сдавливают и ощущаются на теле будто вторая кожа 🥰\n\n"
        "А как красиво сидят 😍\n\n"
        "Тебе точно пора <b>побаловать себя любимую</b> 🔽\n"

...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_74.png'
    ...
    message_template = (
        "<b>— Думаешь, он поймёт?</b>\n\
<b>— Он поймёт даже больше, чем ты думаешь.</b>\n\
    \n\
Когда не хочется говорить намёками, а хочется заявить громко и твёрдо — выбирай свои <b><i>надписи на трусиках</i></b>.\n\
    \n\
💔 дерзкие, стильные, в настроение. Все надписи - в нашем ТГ. Там же забирай ссылки на них."
    )

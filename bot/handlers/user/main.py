...
#
    text_with_link = "<b>Вы сравниваете цены на разных маркетплейсах перед покупкой?</b>\n\
\n\
 ⚡️Согласно исследованиям, более 56% женщин <code>сравнивают</code> цены и выбирают тот маркетплейс, где покупка будет наиболее <code>выгодной</code>.\n\
\n\
🎉 Хорошая новость: <b>Черная пятница уже стартовала на Ozon!</b>\n\
\n\
В этот день можно найти гарантированно самые выгодные предложения.\n\
\n\
<b>Скидки достигают 75% на все товары, включая белье нашего бренда</b>.\n\
\n\
Нажмите, чтобы выбрать комплект всего от 700₽ ❗️❗️❗️\n\
\n\
<i>Кстати,скидка действует и на новинки</i>🔥🔥🔥"

...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_79.png'
    ...
    message_template = (
        "<b>Не прячь отёки под бельём.</b>\n\
\n\
🥑💪🏻 В наш тг-канал мы пригласили <b>клинического нутрициолога</b>, чтобы рассказать, как быстро сбросить пару килограмм, подтянуть тело и убрать лишние складки\n\
— просто <b><u>избавившись от отёков</u></b> 💦\n\
\n\
<b>Забирай статью по ссылке в канале!</b>"
    )

...
async def ready_present(message: types.Message):
    ...
    video_path = 'bot/images/img_8.png'

    text_with_link = "<b>ТОЛЬКО 2 НЕДЕЛИ</b>\n\
Дарим скидку на этот яркий комплект💙\n\
\n\
❗️<b>ВСЕГО 1090₽</b> вместо <s>1290₽</s>❗️\n\
    \n\
         <b>Артикул: <a href='https://www.wildberries.ru/catalog/200840985/detail.aspx?targetUrl=GP'>200840985</a></b>\n\
\n\
— Премиальная невесомая сеточка\n\
— Комфортный лиф с косточками, не давит и не стесняет движения\n\
— Удобные трусики на высокой посадке с хлопковой ластовицей\n\
\n\
...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_11.png'

    blocked_users = 0
    successful_sends = 0

#
    text_with_link = "Напоминаем, что только на этой неделе ты можешь заказать этот классный комплект по супер цене🔥\n\
\n\
<b>❗️ВСЕГО 1090₽ <s>вместо 1290₽❗️</s></b>\n\
\n\
        <b>Артикул:</b> <a href='https://www.wildberries.ru/catalog/200840985/detail.aspx?targetUrl=GP'>200840985</a>\n\
\n\
За счет косточек бюстгальтер лучше поддерживает грудь,\n\
удобные трусики на высокой посадке классно подчеркнут любую фигуру😍\n\
\n\
Поторопись, пока он есть в наличии🫶🏻"

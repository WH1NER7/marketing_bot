...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_55.png'
    ...
    message_template = (
        "<b><i>Девочки, а давайте в этот раз по-другому?</i></b>\n\
    \n\
Почему перед 23 февраля мы всегда думаем, что подарить мужчине, а не себе? <b>Может, пора менять традиции?</b> 🙃\n\
    \n\
Ну честно, искренне ли он обрадуется новым носкам?…\n\
        \n \
😍 а вот ты в идеальном комплекте, который подчеркивает твою женственность – <em>звучит как лучший сюрприз, правда?</em>\n\
    \n\
Выбирай свой образ:\n\
    \n\
1. <a href='https://missyourkiss.mobz.click/q6wpho'>«Без шансов устоять»</a>\n\
2. <a href='https://missyourkiss.mobz.click/l5j6'>«Девушка, с которой не хочется расставаться»</a>\n\
3. <a href='https://missyourkiss.mobz.click/rcwyyy'>«Тайная фантазия»</a>\n\
4. <a href='https://missyourkiss.mobz.click/khzlu'>«Завораживающая богиня»</a>"
    )

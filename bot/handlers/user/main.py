...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_67.png'
    ...
    message_template = (
        "<b>Говорят, что раньше было лучше…</b>\n\
\n\
Но это точно не про женское белье! Корсеты, жесткие косточки, неудобные ткани — спасибо, не надо 🙅‍♀️\n\
\n\
В нашем ТГ-канале мы поделились историей, как менялось нижнее белье до сегодняшнего дня.\n\
\n\
<b>Читаешь — и понимаешь, как повезло родиться в нужное время и в нужном месте</b> 😅"
    )

...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_77.png'
    ...
    message_template = (
        "<b>Мы не хотим, чтобы тебя мучали вопросы —</b>\n\
<i>поэтому мы зовём астролога и дарим тебе бесплатный разбор запроса </i>🔮\n\
\n\
<b>Любая тема:\n\
любовь, деньги, здоровье, предназначение</b>\n\
\n\
Условия в нашем тг-канале 🫶🏻"
    )

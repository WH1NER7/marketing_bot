...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    message_template = (
        "<b>Как совместить всё?</b>\n\
\n\
Ты — не только чья-то жена, мама, сотрудница. Ты — женщина. И ты заслуживаешь заботы, энергии и баланса во всех сферах 🥹\n\
\n\
<i>Читай в нашем тг-канале о том, что поможет вернуть опору и услышать себя ❤️</i>"
    )

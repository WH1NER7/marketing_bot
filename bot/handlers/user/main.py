...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    message_template = (
        "{name}, срочно сними это бельё!\n\
…и надень то, что подчеркнёт твою природную красоту 😍\n\
\n\
В нашем телеграм-канале — <b>новый пост про типажи Кибби и бельё, которое подойдёт тебе по типу лица и тела</b> 🙌🏻\n\
\n\
Читай пост и узнай о себе больше!"
    )

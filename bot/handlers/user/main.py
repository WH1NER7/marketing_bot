...
#
    text_with_link = "Привет, дорогая❤️‍🔥\n\
Сегодня у нас супер предложение только для тебя🤫\n\
\n\
Комплект с косточками и трусиками на высокой посадке в цвете сирень 💙\n\
\n\
❗️ВСЕГО 1090₽ вместо 1290₽❗️\n\
    \n\
        Артикул: <a href='https://www.wildberries.ru/catalog/200840985/detail.aspx?targetUrl=GP'>200840985</a>\n\
\n\

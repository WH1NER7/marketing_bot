...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_58.png'
    ...
    message_template = (
        "<b>{name}, чувствуешь? Весна уже здесь 🌸☀️</b>\n\
    \n\
Лёгкость, свежесть, желание обновлений — всё, что хочется прочувствовать на полную.\n\
    \n\
Мы подготовили для тебя To-Do лист, который поможет словить это состояние. Начни с самого приятного ✨"
    )

...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_57.png'
    ...
    message_template = (
        "Самый ценный момент — это тот, когда ты чувствуешь себя уверенно и свободно. <i><b>Когда бельё не скрывает, а подчёркивает твою индивидуальность.</b></i>\n\
    \n\
❤️‍🔥Наши коллекции — это не просто бельё. Это тот элемент, который помогает тебе <b><u>раскрыть свою уверенность и силу.</u></b> Каждая деталь, каждое прикосновение создаёт атмосферу, в которой <b><u>ты — главная.</u></b>\n\
    \n\
Попробуй бельё Miss Your Kiss — и почувствуй разницу."
    )

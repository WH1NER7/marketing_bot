...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_26.png'

    blocked_users = 0
    successful_sends = 0

#
    text_with_link = "Скидка от 70% на комфортные базовые бюстгальтера!\n\
\n\
Бесшовный бюстгальтер и бандо в 3 цветах: чёрный, белый и бежевый.\n\
\n\
Из легкого и дышащего материала идеально подходит для повседневного ношения.\n\
\n\
✨ Он не давит на грудь и не сползает, поэтому не требует бретелей. Бюстгальтер адаптируется к вашей фигуре и сохраняет форму даже после стирки.\n\
\n\
❤️ Чашки легко вытаскиваются, что добавляет удобства. Более 200 положительных отзывов подтверждают его качество!\n\
\n\
Чтобы приобрести это великолепное белье, просто перейдите по ссылке.\n\
\n\
Не упустите шанс, времени осталось совсем немного!"

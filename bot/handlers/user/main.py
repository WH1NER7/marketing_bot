...
\n\
Скорее переходи в магазин (https://www.wildberries.ru/brands/missyourkiss) кидай в корзину свои желанные комплекты, пока их не раскупили🛒\n\
\n\
...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_12.png'

    blocked_users = 0
    successful_sends = 0

#
    text_with_link = "<b>НОВИНКА УЖЕ В НАЛИЧИИ😱🔥</b>\n\
\n\
<b>OZON <a href='https://ozon.ru/t/xW3g6Q3'>1707103601</a></b>\n\
\n\
<b>Wildberries <a href='https://www.wildberries.ru/catalog/264633760/detail.aspx?targetUrl=MS'>264633760</a></b>\n\
\n\
Бесшовный лиф бандо отлично подойдёт для:\n\
- ежедневной носки\n\
- активного образа жизни\n\
- идеальная поддержки груди\n\
- незаметен под одеждой\n\
\n\
Выбирай свой цвет: белый, бежевый, черный\n\
\n\

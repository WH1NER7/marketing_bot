...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_50.png'
    ...
    message_template = (
        "Девчонки, собрали для вас топ-4 секси комплектов, по мнению мужчин 😍\n\
    \n\
Мы опросили мужей, братьев, коллег и даже пару случайных прохожих. Какой комплект сильно хочется снять?\n\
        \n \
Из 30 фотографий, выбраны именно эти комплекты.\n\
        \n \
Порадуй своего мужчину в День Святого Валентина ❤️ Еще и по приятным ценам ❤️"
    )

...
#
    text_with_link = "<b>Твой парень давно не дарил тебе цветы?</b> 💐\n\
\n\
Если прошло больше 1 дня, значит пора поделиться с ним ссылкой на цветочную новинку.\n\
\n\
Вместе с ним вы почувствуете  атмосферу нежности и ярких эмоций.\n\
\n\
Добавь цветочный принт в свой гардероб!\n\
\n\
<b>Закажи</b> нашу новинку - пусть цветы цветут всегда!🌷"

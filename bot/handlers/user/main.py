...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_64.png'
    ...
    message_template = (
        "<b>Вчера в Телеграме мы раскрыли нечто особенное… 💔</b>\n\
\n\
Новая коллекция КУПАЛЬНИКОВ — любовь с первого взгляда. Мы пересмотрели кадры миллион раз и до сих пор в восторге!\n\
\n\
😍 Что за коллекция? Почему она уже свела нас с ума? Как купить?\n\
\n\
Подписывайся на наш Телеграм и будь в курсе всех новостей 👀"
    )

...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    text_with_link = "До лета осталось 8 ДНЕЙ 🤩😱\n\
Пора приводить себя в форму! \n\
\n\
НОВАЯ ФОРМА ДЛЯ СПОРТА сделает подготовку к лету намного приятнее 🏋🏽‍♀️\n\
Сеточка тянется, не натирает, в ней не жарко, а еще что самое главное — она стильная 💔\n\
Занимайся спортом вместе с MYK!\n\
\n\
🔗 [КРОП ТОП](https://www.wildberries.ru/catalog/162325139/detail.aspx?targetUrl=MS)"

...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_59.png'
    ...
    message_template = (
        "<b>{name}, а ты уверена?</b>\n\
    \n\
Что подарок на 8 Марта тебе кто-то выберет лучше, чем <u>ты сама?</u>\n\
    \n\
Что ожидание сюрприза лучше, чем <u>удовольствие от выбора?</u>\n\
    \n\
Что ты не можешь позволить себе лучшее <u>просто так?</u>\n\
    \n\
😌❤️ <i>Выбирай сама. Выбирай сейчас. Ты достойна.</i>"
    )

...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_70.png'
    ...
    message_template = (
        "<b>WB завис… потому что вы массово скупаете нашу новую коллекцию 😲❤️</b>\n\
\n\
Самые желанные купальники этого лета <u>уже в наличии</u> — твой ждёт тебя на WB!"
    )

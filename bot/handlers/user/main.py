...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_75.png'
    ...
    message_template = (
        "<b><u>Что ждет тебя в отношениях?</u></b> 🔮\n\
    \n\
Мы пригласили <b>таролога</b> на наш телеграмм-канал, чтобы ты могла задать волнующий вопрос\n\
и получить <b><u>бесплатный ответ от профессионала!</u></b>\n\
    \n\
✨ <i>Ответ, который может изменить всё. Переходи в наш канал и пиши свой запрос!</i>"
    )

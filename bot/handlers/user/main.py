...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_66.png'
    ...
    message_template = (
        "<b>Те самые трусики, которые идеально подойдут под любую одежду 🤍</b>\n\
    \n\
Есть вещи, которые хочется носить каждый день – удобные, мягкие, идеально сидящие. Именно такие <b><u>трусики-бразилианы</u></b>: <i>они не давят, не скручиваются, незаметны даже под самой облегающей одеждой и красиво подчёркивают фигуру.</i>\n\
    \n\
👀😍 А сейчас они еще и в новых принтах"
    )

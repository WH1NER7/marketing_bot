...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_37.png'
    ...
    message_template = (
        "{name}, поздравляем тебя с Новым годом, красотка!\n\
\n\
Новый год – это время новых начинаний, новых планов и… новых комплектов белья! 😉 Мы так рады, что ты с нами, и желаем тебе в Новом году море позитива, уверенности в себе и, конечно же, комфорта в каждом мгновении!\n\
\n\
Пусть все твои желания исполнятся! С Новым годом! ❤️"
)

...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_65.png'
    ...
    message_template = (
        "Пополнение. Счет RUB. 75000 RUB.\n\
Андрей Р. Доступно 452678,32 RUB.\n\
\n\
Вот какие уведомления действительно радуют глаз! 😏\n\
А еще — <b>уведомление о том, что твой новый комплект уже в пункте выдачи!</b>\n\
\n\
Потому что ничто так не повышает настроение, как красивое белье, созданное для комфорта и уверенности 💋"
    )

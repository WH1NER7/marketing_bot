...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_29.png'
    ...
    message_template = (
        "<b>{name} думаю, тебе знакомо это чувство…\n\
\n\
<span class='tg-spoiler'>Когда надеваешь, например, платье из шелка или какой-то тонкий трикотаж, и вот эти линии от белья сразу становятся видны, а хочется выглядеть идеально 💫</span></b>\n\
\n\
▫️Для таких случаев лучше выбирать бесшовное белье. Оно вообще незаметное, и главное — комфортное!\n\
\n\
▫️А вот в трусиках с высокой посадкой линия талии не выглядывает. Это очень помогает сделать силуэт гладким и без лишних складок\n\
\n\
▫️Но для облегающих брюк или юбок, стринги — это лучший вариант. Они вообще не оставляют никаких следов, да и сидят идеально, если правильно подобрать размер\n\
\n\
<b>Закажи белье по вашим пожеланиям по ссылке 👇\n\
\n\
Не упусти шанс, времени осталось совсем немного!♥️</b>"
)

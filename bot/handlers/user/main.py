...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_48.png'
    ...
    message_template = (
        "{name}, готова к 14 февраля? 😏\n\
    \n\
Ты уже знаешь, что мы выпустили лимитированный комплект белья, идеально подходящий для романтичных дней? 💞\n\
    \n\
Представляешь: минималистичный дизайн, очаровательные сердечки — море нежности и любви! А с подходящими аксессуарами… ты точно его очаруешь!\n\
    \n\
Скорее беги смотреть!"
    )

...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_45.png'
    ...
    message_template = (
        "{name}, мы хотим быть ближе🥰\n\
\n\
Специально для тебя и твоего удобства мы создали Telegram-канал.\n\
    \n\
Здесь ты будешь первой узнавать о новинках, акциях и специальных предложениях.\n\
    \n\
🙌🏽 А самое крутое:\n\
—Ты сможешь участвовать в выборе будущих коллекций!\n\
— Получать эксклюзивные промокоды.\n\
— Быть в курсе всех событий раньше остальных.\n\
    \n\
Ждем тебя в нашем Telegram-канале! ❤️"
    )

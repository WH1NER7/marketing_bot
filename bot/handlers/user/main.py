...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_62.png'
    ...
    message_template = (
        "<b>{name}, нашла идеальные трусики?</b>\n\
    \n\
🔥Эти <b>бразилианы</b> — как вторая кожа: мягкие, удобные, незаметные под одеждой и при этом подчёркивают фигуру. <b>Никаких складок, передавливания и скручивания</b> — только комфорт и идеальная посадка.\n\
    \n\
Выбери свой цвет и собери комплект мечты 😍"
    )

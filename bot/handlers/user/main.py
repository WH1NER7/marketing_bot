...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_44.png'
    ...
    message_template = (
        "{name}, что делаешь на выходные?\n\
\n\
А если провести время со своим партнером ?  Напишите на бумажках креативные идей и доставайте одну раз в неделю.\n\
\n\
К примеру:\n\
<b>Кулинарный поединок</b>: Кто приготовит самый вкусный ужин?\n\
<b>Первое свидание</b>: Вспомните свое первое свидание: во что вы были одеты, куда ходили?\n\
<b>Арт-вечеринка</b>: Посетите мастер-класс, где вы вместе будете рисовать под руководством художника.\n\
\n\
Совместное времяпровождение имеет огромное значение для отношений ❤️"
    )

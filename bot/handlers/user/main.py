...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    message_template = (
        "<b>Собираешься в отпуск? 🐚</b>\n\
Вот три вещи, которые точно должны быть в твоем чемодане:\n\
    \n\
— <b>Слитный “умный” купальник</b> — защищает от ожогов, солнца и неловких ситуаций (да, у него SPF 35);\n\
— <b>Бикини MYK</b> — для вечеров, фотосессий и красивого загара;\n\
— <b>Пляжная туника с SPF</b> — лёгкая, дышащая и спасает от палящего солнца.\n\
    \n\
Собирай свой идеальный отпускной комплект с MissYourKiss ❤️"
    )

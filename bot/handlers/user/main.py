...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_14.png'
...
\n\
Что может быть приятнее, чем новые покупочки для себя?🛍️\n\
\n\
Получить за это квартиру в Москве, последний айфон или что-то еще крутое🤩\n\
\n\
На вайлдберис сейчас как раз розыгрыш этих крутых призов при покупке от 4000₽🔥\n\
\n\
Порадуй себя <a href='https://www.wildberries.ru/brands/missyourkiss'>новым классным бельем</a> и может именно ты сможешь выиграть один из призов✨"

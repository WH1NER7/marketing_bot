...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_23.png'

    blocked_users = 0
    successful_sends = 0

#
    text_with_link = "Способ №1. Оплатите всю корзину WB с его карты. 😁👍🏻\n\
\n\
Способ №2. Строго скажите: «И НИКАКОЙ РУГАНИ ТЕБЕ ЦЕЛЫЙ МЕСЯЦ». 🫣 (В женщине должна быть загадка) \n\
\n\
Способ №3. Скажи, что выпила волшебную таблетку и теперь голова никогда не будет болеть. 🥰\n\
\n\
Способ №4. Разложи рядом с разбросанными носками свои. Ведь это любовь."

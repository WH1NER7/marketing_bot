...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_51.png'
    ...
    message_template = (
        "Девушки, мы получили множество восторженных отзывов о нашем бордовом цвете.  Многие из вас просили выпустить лонгслив именно в этом оттенке…🤤\n\
\n\
Мы вас услышали и отшили его!\n\
Ловите первыми ссылку на эту новинку! 🤩\n\
Роскошный лонгслив, в трендовом цвете, с сексуальным швом спереди.\n\
\n\
Успевай, это партия ограниченна, осталось 50 шт."
    )

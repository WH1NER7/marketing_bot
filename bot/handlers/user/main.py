...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    photo_path1 = 'bot/images/img_78.png'
    ...
    message_template = (
        "<b>Солнце, загар\n\
и ни одного ожога ☀️</b>\n\
    \n\
Новинка, о которой мы мечтали весь холодный сезон — <b><u>умные купальники</u> Miss Your Kiss</b>.\n\
    \n\
😍🔥 <b>умный материал помогает коже загорать равномерно,</b> не оставляя следов и ожогов\n\
    \n\
<i>Все принты, которые скоро будут в наличии, и ссылки на них — уже в нашем телеграм-канале ✨</i>"
    )

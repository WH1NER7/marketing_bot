...
async def send_broadcast_with_media_group(photo_paths, message_text):
    ...
    text_with_link = "За окном солнечно, пора брать купальники и отправляться за красивым загаром ☀️\n\
Вот подборка мест где можно это сделать в Казани :\n\
📍Пляж у бассейна Ривьера \n\
📍Открытый бассейн Свияжских холмах\n\
📍Летняя терраса спорт клуба «Максимус»\n\
\n\
Возьми с собой крем для загара с SPF 🧴\n\
[КУПАЛЬНИК](https://www.wildberries.ru/catalog/218272630/detail.aspx?targetUrl=MS)\n\
[ПЛЯЖНЫЕ ШТАНЫ](https://www.wildberries.ru/catalog/226608461/detail.aspx?targetUrl=MS)\n\
[КРОП – ТОП](https://www.wildberries.ru/catalog/158417968/detail.aspx?targetUrl=MS)"
